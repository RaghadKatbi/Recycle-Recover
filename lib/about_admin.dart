...
import 'package:recycle_recover/account_admin.dart';
import 'Account user.dart';


class about_admin extends StatefulWidget {
  @override
  State<StatefulWidget> createState() {
    return about_admin_state();
  }
}

class about_admin_state extends State<about_admin> {
  late String Email="";
  ...
  void update() async{
    CollectionReference userinfo= FirebaseFirestore.instance.collection("admin");
    setState(() {
      print("=================");
      print('$id');
      userinfo.doc(id).set({

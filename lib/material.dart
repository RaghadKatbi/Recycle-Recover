...
class material_State extends State<material>
{
                    ...
                    children: [
                      ...
                      Container(
                          ...
                          child: ElevatedButton(
                              ...
                              child:Opacity(opacity:y, child: Image.asset("image/cloths.jpg"),),
                              style: ButtonStyle(
                                backgroundColor:
                      ...
                      Container(
                        ...
                        child: ElevatedButton(
                            ...
                            child:Opacity(opacity:z,child: Image.asset("image/plastic.jpg"),),
                            style: ButtonStyle(
                              backgroundColor:
                              MaterialStateProperty.resolveWith((states) {
                                if (states.contains(MaterialState.pressed))
                      ...
                      children: [
                        Container(
                            ...
                            child: ElevatedButton(
                                ...
                                child:Opacity(opacity:n,child: Image.asset("image/glass.jpg")),
                                style: ButtonStyle(
                                  backgroundColor:
                                  MaterialStateProperty.resolveWith((states) {
                                    if (states.contains(MaterialState.pressed))
                        ...
                        Container(
                          ...
                          child: ElevatedButton(
                              ...
                              child: Opacity(
                                opacity:x,
                                child: Image.asset("image/wood.jpg",fit: BoxFit.cover,),
                              ),
                              style: ButtonStyle(
                                backgroundColor:
                                MaterialStateProperty.resolveWith((states) {
  ...
  void addMaterial () async
  {
    ...
    FirebaseFirestore.instance.collection("material").add(
        {
          'id': userid,
          'wood':x,
          'plastic' :z,
